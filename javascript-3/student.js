//////////////////SETUP////////////////////
// Close all other index.html files and open the index.html file in javascript-3/DO_NOT_EDIT/index.html.
// You should see an input field and a button that says "Add Item".

//////////////////STEP 1////////////////////
//Create an array called 'groceries' that contains three grocery items as strings. 

const groceries = ["banana", "milk", "coffee"];

//////////////////STEP 2////////////////////
//Create a variable called 'yourName' that is assigned the value of your name as a string. 

const yourName = "Veronica";
...
//////////////////STEP 6////////////////////
//Create a function called 'checkGroceryCount'.
// Inside of checkGroceryCount, you're going to check the total number of groceries in your groceries array using .length.
...
// now be able to add items to your grocery list with a dynamic total showing. If you double click on an item, it should remove that item
