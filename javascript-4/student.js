...
const faveColors = ["purple", "blue", "violet"];
...
const me = {
	firstName: "Veronica",
	superHeroName: "Cat Woman",
	homeTown: "Austin",
	superPowers: ["Super Miau", "Claws of Justice", "Kitty Eyes"],
...
// The first variable you create should be 'regularName',
...
// Next, create a for loop to loop over the remaining three colors.
// If any of the colors is 'blue', change it's value to '#4D4DFF'
...
// which will take each item of the array as an argument.
// Remember, you did not create the createLi function.
...
// In your function, loop over the obj parameter passed in, and change each keys value to 'redacted'.
